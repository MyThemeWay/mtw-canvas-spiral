...
<img src="https://img.shields.io/github/repo-size/mythemeway/mtw-canvas-spiral?label=RepoSize" />
<a title="Check it out" target="_blank" href="https://github.com/mythemeway/mtw-canvas-spiral/blob/main/LICENSE.txt"><img src="https://img.shields.io/badge/License-CC_BY_NC_SA_3.0-blue.svg?color=2A2E30" /></a>
<a title="Check it out" target="_blank" href="https://github.com/mythemeway/mtw-canvas-spiral/releases"><img src="https://img.shields.io/github/v/release/mythemeway/mtw-canvas-spiral?label=LastRelease" /></a><br>
