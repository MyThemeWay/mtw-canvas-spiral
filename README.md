...
> 
> * Fragment shader is based on [ARQVOID :: 240 chars](https://www.shadertoy.com/view/NscXR8/ "Check it out") [License: [CC&nbsp;BY-NC-SA&nbsp;3.0](https://www.shadertoy.com/terms "Go there"); Copyright: © 2021 ENDESGA & Xor; Changes: made]
...
<script src="https://cdn.jsdelivr.net/gh/mythemeway/mtw-canvas-spiral@0.0.2/boilerplate-canvas/twgl/canvas.bundle.min.js"></script>
```
