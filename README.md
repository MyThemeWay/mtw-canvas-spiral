<h1 align="center">MTW-CANVAS-SPIRAL</h1>
...
<img src="https://img.shields.io/github/repo-size/mythemeway/mtw-canvas-spiral?label=RepoSize&cacheSeconds=3600" />
<a title="Check it out" target="_blank" href="https://github.com/mythemeway/mtw-canvas-spiral/blob/main/LICENSE.txt"><img src="https://img.shields.io/badge/License-CC_BY_NC_SA_3.0-blue.svg?color=2A2E30&cacheSeconds=3600" /></a>
<a title="Check it out" target="_blank" href="https://github.com/mythemeway/mtw-canvas-spiral/releases"><img src="https://img.shields.io/github/v/release/mythemeway/mtw-canvas-spiral?label=LastRelease&cacheSeconds=3600" /></a><br>
...
> * Fragment shader is based on [ARQVOID :: 240 chars](https://www.shadertoy.com/view/NscXR8/ "Check it out") [License: [CC&nbsp;BY-NC-SA&nbsp;3.0](https://www.shadertoy.com/terms "Go there"); Copyright: ©️ 2021 ENDESGA & Xor; Changes: made]

## | Usage

E.&nbsp;g. as a 3D animated background 

### Directory: [boilerplate-canvas](https://github.com/MyThemeWay/mtw-canvas-spiral/tree/main/boilerplate-canvas "Check it out")
...
<script src="https://cdn.jsdelivr.net/gh/mythemeway/mtw-canvas-spiral@0.0.1/boilerplate-canvas/twgl/canvas.bundle.min.js"></script>
```
...
### Directory: [boilerplate-website](https://github.com/MyThemeWay/mtw-canvas-spiral/tree/main/boilerplate-website "Check it out")
...
#### <b>Explore</b>: [Demo](https://mythemeway.github.io/mtw-canvas-spiral/ "Check it out") with Website-Boilerplate [Dark-Particle v4.0](https://github.com/MyThemeWay/Dark-Particle "Check it out")
